...
public class Fondo {
	...
	public Fondo(TextureRegion image, OrthographicCamera gameCam, float scale) {
		this.image = image;
		this.gameCam = gameCam;
		this.scale = scale;
		numDrawX = Juego.V_WIDTH / image.getRegionWidth() + 1;
		numDrawY = Juego.V_HEIGHT / image.getRegionHeight() + 1;
	}
